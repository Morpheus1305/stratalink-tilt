          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <Card className="border-border ">
              <CardHeader className="pb-2">
                <TT title="Coverage Panel" body="How many configured venues are contributing data for this token right now. 100% = full supervisory coverage, no blind spots. Partial coverage may occur for tokens not listed on all 26 venues - this reflects genuine market structure, not a system error.">
