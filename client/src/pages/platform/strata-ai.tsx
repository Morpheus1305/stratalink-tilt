...
export default function StrataAI() {
  ...
  const agg: TsleAggregate | null = rawAgg ? {
    ...
    vol_regime:            rawAgg.vol_regime              ?? "NORMAL",
    symbol:                rawAgg.symbol                  ?? selectedSymbol,
    computed_at_utc:       rawAgg.computed_at_utc         ?? Date.now(),
        ...
        <div className="tilt-header" data-testid="strata-ai-header">
          ...
          <div style={{ marginLeft: "auto", display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <div style={{ fontFamily: "var(--tilt-mono)", fontSize: 10, color: "var(--tilt-muted)" }}>
              16 VENUES &middot; 6 DETECTION CATEGORIES &middot; REAL-TIME
            </div>
