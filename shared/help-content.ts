...
export const USER_GUIDE_SECTIONS: GuideSection[] = [
  {
    ...
    subsections: [
      ...
      {
        id: "token-selector",
        title: "ILU-20 Token Selector",
        body: "The token selector dropdown shows all 20 ILU tokens grouped by five systemic categories: Reserve Assets, Stablecoin Infrastructure, Exchange and Trading Infrastructure, Financial Infrastructure, and High-Volume Liquidity Assets. Each token shows its LIVE status (actively receiving venue data) or — (in universe but awaiting feed activation). Selecting a token updates every page in the platform.",
      },
      {
        id: "ticker",
        title: "ILU-20 Ticker",
        body: "The persistent ticker bar at the bottom of every page scrolls all 20 ILU assets with their current PoLi scores. The ticker provides constant market context regardless of which page you are viewing. Hover over the ticker to pause scrolling.",
      },
    ],
  },
  {
...
export const FAQ_SECTIONS: FaqSection[] = [
  {
    ...
    title: "General",
    items: [
      { q: "What is TILT?", a: "TILT stands for The Institutional Liquidity Truth. It is Stratalink's platform for independent, real-time, cross-venue liquidity verification and market integrity intelligence. It monitors the Institutional Liquidity Universe (ILU-20): 20 digital assets selected by systemic importance across five categories." },
      ...
      { q: "Why are some tokens showing — instead of data?", a: "The ILU-20 defines 20 systemically important assets. Active venue data feeds may not yet be enabled for all 20. Tokens showing — are in the universe and will display data once their venue feeds are activated. The system does not show invented or placeholder data." },
